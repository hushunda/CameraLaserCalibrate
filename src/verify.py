...
def main():
    ...
    # R_TCL = np.array([[-0.08121125 ,-0.99669284 ,-0.00284709],
    #          [ 0.07005867, -0.00285892 ,-0.99753878],
    #          [ 0.99423162 ,-0.08121083 , 0.07005915]])
    # T_TCL = np.array([ 0.08605522 , 1.13803694, -0.19606882])
    ...
    for laser,image in zip(laseres,images):
        ...
        for p in pixel_points:
            cv2.circle(image, (int(p[0]), int(p[1])), 1, (255, 255, 0), -1)
